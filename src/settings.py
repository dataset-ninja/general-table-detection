...
HOMEPAGE_URL: str = (
    "https://www.kaggle.com/datasets/rhtsingh/general-table-recognition-dataset/data"
)
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 9432495
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/general-table-detection"
...
DOWNLOAD_ORIGINAL_URL: Optional[
    Union[str, dict]
] = "https://www.kaggle.com/datasets/rhtsingh/general-table-recognition-dataset/download?datasetVersionNumber=3"
